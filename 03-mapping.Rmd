...
ggplot(travis_fa_map) + 
  ...
  labs(
    ...
    caption="By: Christian McDonald; Source: USDA, 2015 data", fill = "Food access")
...
ggplot(travis_fa_map) + 
  ...
  labs(
    ...
    subtitle = "Tracts where a significant number or share of residents are low income and lack access\nto a supermarket within a certain distance.",
    caption="By: Christian McDonald; Source: USDA, 2015 data", fill = "Access to supermarket")
